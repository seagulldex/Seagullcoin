...
/**
 * Confirms the payment transaction matches the required SeagullCoin (0.5) payment.
...
export async function confirmPayment(txId) {
  try {
    ...
    const correctPayment =
      txData.Destination === 'rHN78EpNHLDtY6whT89WsZ6mMoTm9XPi5U' &&  // Service wallet
      typeof amount === 'object' &&
      amount.currency === 'SGLCN-X20' &&
      amount.issuer === 'rnqiA8vuNriU9pqD1ZDGFH8ajQBL25Wkno' &&  // SeagullCoin issuer
